  ...
  return (
    <main className="shell">
      <section className="hero">
        ...
        <p>
          A static index generated by GitHub Actions. Browse repositories found in GitHub code search results whose workflow files contain
      ...
      <section className="panel controls" aria-label="Result controls">
        ...
        <div>
          <span className="stat">{data?.retrievedFileCount ?? '-'}</span>
          <span className="muted"> matching files retrieved for this static index</span>
        </div>
        <label>
          Language
      ...
      <section className="panel data-note">
        ...
        {data?.searchResultLimitReached ? (
          <div className="notice">
            GitHub's code search API reports more matches than it allows this app to retrieve. This is an indexed subset, not a complete GitHub-wide census.
          </div>
        ) : null}
      </section>
