...
The data generation workflow commits the updated JSON back to `main` only when the generated file changes. It does not deploy GitHub Pages itself; run the separate `Deploy GitHub Pages` workflow when you want to publish the checked-in data.
